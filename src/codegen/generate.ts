...
export function generate(project: Project): { files: GeneratedFiles; ir: Ir } {
  ...
  const cmakeHeader = `# AUTO-GENERATED BY esp-ai. DO NOT EDIT.\n# Regenerate via the Code pane; manual edits will be overwritten.\n`
  const cmake = [
    cmakeHeader,
  ...
  const sdkconfigHeader = `# AUTO-GENERATED BY esp-ai. DO NOT EDIT.\n# Regenerate via the Code pane; manual edits will be overwritten.\n`
...
function boardSdkconfigFlags(target: string, usbPins: string[]): string[] {
  ...
  switch (target) {
    case 'esp32s3':
      ...
      if (usbPins.length > 0) flags.push('CONFIG_ESP_CONSOLE_USB_CDC=y')
      break
    case 'esp32c3':
      ...
      break
    case 'esp32c6':
      flags.push('CONFIG_IEEE802154_ENABLED=y')
      break
  }
  return flags
}
