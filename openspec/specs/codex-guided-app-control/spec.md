# codex-guided-app-control Specification

## Purpose
Codex guided app control standardizes how the AI assistant sees and operates Circuitiny on behalf of a learner. It exists so developers and reviewers can keep automation scoped, inspectable, beginner-friendly, and safe while still allowing Codex to use structured project state, screenshots, and app-local controls.
