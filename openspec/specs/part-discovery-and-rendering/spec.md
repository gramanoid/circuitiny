# part-discovery-and-rendering Specification

## Purpose
Part discovery and rendering defines how Circuitiny recommends components from beginner goals, records metadata confidence, and renders parts even when a polished GLB model is not available. The scope covers local-catalog-first recommendations, draft/external part handling, companion-part guidance, and safe fallback visualization.
## Requirements
