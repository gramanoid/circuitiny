...
The system SHALL allow a confirmed recommendation to become a guided Circuitiny recipe or project draft after learner approval.
...
- **THEN** the system SHALL re-rank recommendations with a stronger novelty preference while preserving safety and beginner explanations.
